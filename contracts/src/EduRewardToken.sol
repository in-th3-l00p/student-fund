 ...
 * @notice ERC20 token used for distributing rewards within the EduChain protocol.
 *         Uses role-based access control for minting to support authorized reward distributors.
 */
contract EduRewardToken is ERC20, ERC20Burnable, AccessControl {
     ...
     */
    constructor(address admin, uint256 initialSupply) ERC20("EduReward", "RWD") {
